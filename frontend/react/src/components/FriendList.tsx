...
export const FriendList: React.FC<FriendListProps> = ({ friends }) => {
	...
	return (
		<div className="flex flex-col justify-center items-center"><ul className="m-5 flex flex-col">
			{friends.map((friend) => (
				<li key={friend.id} className="flex items-center space-x-2 hover:font-bold hover:underline hover:text-amber-200">
