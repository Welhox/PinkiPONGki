...
const createTournamentSchema = {
  ...
  response: {
    200: {
      ...
      required: ['id', 'name', 'size', 'createdById', 'status', 'createdAt', 'updatedAt']
    },
    400: { type: 'object', properties: { error: { type: 'string', example: 'Invalid size' } }, required: ['error'] },
    500: { type: 'object', properties: { message: { type: 'string', example: 'Server error' } }, required: ['message'] }
  }
}
...
const registerTournamentSchema = {
  ...
  response: {
    ...
    400: { type: 'object', properties: { message: { type: 'string', example: 'Invalid tournament ID' } }, required: ['message'] },
    500: { type: 'object', properties: { message: { type: 'string', example: 'Server error' } }, required: ['message'] }
  }
}
  ...
  response: {
    200: {
      ...
      items: {
        ...
        required: ['id','name','size','createdById','status','createdAt','updatedAt','participants']
      }
    },
    500: { type: 'object', properties: { message: { type: 'string', example: 'Server error' } }, required: ['message'] }
  }
...
const getTournamentSchema = {
  ...
  response: {
    200: {
      ...
      required: ['id','name','size','createdById','status','createdAt','updatedAt','participants','matches']
    },
    404: { type: 'object', properties: { message: { type: 'string', example: 'Tournament not found' } }, required: ['message'] },
    500: { type: 'object', properties: { message: { type: 'string', example: 'Server error' } }, required: ['message'] }
  }
}
